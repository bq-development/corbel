...
public class DefaultResmiService implements ResmiService {
    ...
    @Override
    public JsonArray findCollectionDistinct(ResourceUri uri, Optional<CollectionParameters> apiParameters, List<String> fields, boolean first) throws BadConfigurationException, ResmiAggregationException {
